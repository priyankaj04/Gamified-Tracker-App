...
const ART = {
  shisui: require('@/assets/images/naruto/ShisuiUchiha.png'),
  sakura: require('@/assets/images/naruto/SakuraHarano.png'),
  gaara: require('@/assets/images/naruto/Gaara.png'),
  raikage3: require('@/assets/images/naruto/ThirdRaikage.png'),
  hiruzen: require('@/assets/images/naruto/HiruzenSarutobi.png'),
  killerb: require('@/assets/images/naruto/KillerB.png'),
  orochimaru: require('@/assets/images/naruto/Orochimaru.png'),
  jiraiya: require('@/assets/images/naruto/Jiraiya.png'),
  kabuto: require('@/assets/images/naruto/KabutoYakushi.png'),
  tobirama: require('@/assets/images/naruto/TobiramaSenju.png'),
  minato: require('@/assets/images/naruto/MinatoNamikaze.png'),
  nagato: require('@/assets/images/naruto/Nagato.png'),
  itachi: require('@/assets/images/naruto/ItachiUchiha.png'),
  kakashi: require('@/assets/images/naruto/KakashiHatake.png'),
  obito: require('@/assets/images/naruto/ObitoUchiha.png'),
  guy: require('@/assets/images/naruto/MightGuy.png'),
  hashirama: require('@/assets/images/naruto/HashiramaSenju.png'),
  madara: require('@/assets/images/naruto/MadaraUchiha.png'),
  sasuke: require('@/assets/images/naruto/SasukeUchiha.png'),
  naruto: require('@/assets/images/naruto/NarutoUzumaki.png'),
} as const;
